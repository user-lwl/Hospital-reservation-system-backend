package com.lwl.yygh.user.utils;
...
public class HttpClientUtils {
   ...
   @SuppressWarnings("unused")
   public static String get(String url) throws GeneralSecurityException, IOException {
      return get(url, CHARSET, null, null);
   }

   @SuppressWarnings("unused")
   public static String get(String url, String charset) throws GeneralSecurityException, IOException {
